...
// Check for required PHP version
    ...
    public function admin_notice_missing_main_plugin() {
        ...
        $message = sprintf(
            ...
            esc_html__( '"%1$s" requires "%2$s" to be installed and activated.', 'kerapy-core' ),
            '<strong>' . esc_html__( 'Kerapy Core', 'kerapy-core' ) . '</strong>',
            '<strong>' . esc_html__( 'Elementor', 'kerapy-core' ) . '</strong>'
        );
    ...
    public function admin_notice_minimum_elementor_version() {
        ...
        $message = sprintf(
            ...
            esc_html__( '"%1$s" requires "%2$s" version %3$s or greater.', 'kerapy-core' ),
            '<strong>' . esc_html__( 'Kerapy Core', 'kerapy-core' ) . '</strong>',
            '<strong>' . esc_html__( 'Elementor', 'kerapy-core' ) . '</strong>',
    ...
    public function admin_notice_minimum_php_version() {
        ...
        $message = sprintf(
            ...
            esc_html__( '"%1$s" requires "%2$s" version %3$s or greater.', 'kerapy-core' ),
            '<strong>' . esc_html__( 'Kerapy Core', 'kerapy-core' ) . '</strong>',
            '<strong>' . esc_html__( 'PHP', 'kerapy-core' ) . '</strong>',
